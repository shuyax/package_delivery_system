...
let packages = [
    ...
    ['231 Canyon Rd', 'EOD', 'Salt Lake City', '84103', '2', ['at the hub', ''], [40.77477275, -111.8859662], 'UT'],
    ...
    ['3060 Lester St', '10:30 AM', 'West Valley City', '84119', '88', ['at the hub', ''], [40.70554249041934, -111.93634152444814], 'UT'],
    ...
    ['300 State St', 'EOD', 'Salt Lake City', '84103', '2', ['at the hub', ''], [40.77554485, -111.8877297], 'UT'],
    ...
    ['4300 S 1300 E', '10:30 AM', 'Millcreek', '84117', '88', ['at the hub', ''], [40.676338, -111.85421], 'UT'],
    ['4580 S 2300 E', '9:00 AM', 'Holladay', '84117', '4', ['at the hub', ''], [40.671442125, -111.8246463125], 'UT'],
    ['4580 S 2300 E', '10:30 AM', 'Holladay', '84117', '88', ['at the hub', ''], [40.671442125, -111.8246463125], 'UT'],
    ['3148 S 1100 W', 'EOD', 'Salt Lake City', '84119', '2', ['at the hub', ''], [40.702959, -111.92551170210548], 'UT'],
    ['1488 4800 S', 'EOD', 'Salt Lake City', '84123', '6', ['at the hub', ''], [40.66421465374496, -111.93332964058986], 'UT'],
    ['177 W Price Ave', 'EOD', 'Salt Lake City', '84115', '37', ['at the hub', ''], [40.6918197, -111.8958107], 'UT'],
    ['3595 Main St', '10:30 AM', 'Salt Lake City', '84115', '37', ['at the hub', ''], [40.693347499753145, -111.8910192084904], 'UT'],
    ...
    ['5383 South 900 East', '10:30 AM', 'Salt Lake City', '84117', '7', ['at the hub', ''], [40.65408634735715, -111.86581630694714], 'UT'],
    ['5383 South 900 East', 'EOD', 'Salt Lake City', '84117', '25', ['at the hub', ''], [40.65408634735715, -111.86581630694714], 'UT'],
    ['1160 Dalton Ave S', 'EOD', 'Salt Lake City', '84104', '5', ['at the hub', ''], [40.74600233728327, -111.92372726468476], 'UT'],
    ['2835 Main St', 'EOD', 'Salt Lake City', '84115', '7', ['at the hub', ''], [40.7096065, -111.89082078488806], 'UT'],
    ...
    ['3365 S 900 W', 'EOD', 'Salt Lake City', '84119', '1', ['at the hub', ''], [40.6986231, -111.91635], 'UT'],
    ...
    ['1160 Dalton Ave S', 'EOD', 'Salt Lake City', '84104', '88', ['at the hub', ''], [40.74600233728327, -111.92372726468476], 'UT'],
    ['2300 Parkway Blvd', 'EOD', 'West Valley City', '84119', '88', ['at the hub', ''], [40.712313, -111.954034], 'UT'],
    ['450 S State St', '10:30 AM', 'Salt Lake City', '84111', '2', ['at the hub', ''], [40.75956505, -111.88909256720231], 'UT'],
    ['450 S State St', 'EOD', 'Salt Lake City', '84111', '9', ['at the hub', ''], [40.75956505, -111.88909256720231], 'UT'],
